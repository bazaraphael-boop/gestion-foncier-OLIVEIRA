...
export default function AdminLocationHUD({
  ...
  return (
    <div className="bg-slate-900 border-b border-slate-800 text-slate-100 px-2.5 sm:px-4 py-1.5 sm:py-2.5 shadow-lg select-none z-[1050] transition-all animate-in slide-in-from-top-2 duration-200">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-2 sm:gap-2.5 text-xs">
